...
export const FallbackErrorMessages: Record<ErrorCode, string> = {
  // Generic Errors
  [ErrorCode.INTERNAL_SERVER_ERROR]: 'An internal server error has occurred. Please try again later.',
  [ErrorCode.VALIDATION_FAILED]: 'The submitted data is not valid. Please review the information.',
  [ErrorCode.RESOURCE_NOT_FOUND]: 'The requested resource was not found.',
  [ErrorCode.UNAUTHORIZED]: 'You are not authorized to access this resource.',
  [ErrorCode.FORBIDDEN]: 'Access forbidden. You do not have sufficient permissions.',

  // Authentication Errors
  [ErrorCode.AUTH_INVALID_CREDENTIALS]: 'Invalid email or password. Please check your credentials.',
  [ErrorCode.AUTH_EMAIL_IN_USE]: 'This email is already registered. Use a different email.',
  ...
  // Password Reset Errors
  [ErrorCode.PASSWORD_RESET_TOKEN_INVALID]: 'The password reset token is invalid or has expired.',
  [ErrorCode.PASSWORD_RESET_TOKEN_EXPIRED]: 'The password reset token has expired.',

  // Center Related Errors
  [ErrorCode.CENTER_NOT_FOUND]: 'Medical center not found.',
  [ErrorCode.CENTER_USER_NOT_MEMBER]: 'You are not a member of this medical center.',
  [ErrorCode.CENTER_INSUFFICIENT_PERMISSIONS]: 'You do not have sufficient permissions in this medical center.',
  [ErrorCode.CENTER_USER_ALREADY_EXISTS]: 'The user already exists in this medical center.',
  [ErrorCode.CENTER_USER_NOT_EXISTS]: 'The user does not exist in this medical center.',
  [ErrorCode.CENTER_NO_ASSOCIATION]: 'No medical center is associated with your account.',

  // Patient Related Errors
  [ErrorCode.PATIENT_NOT_FOUND]: 'Patient not found.',
  [ErrorCode.PATIENT_EMAIL_DUPLICATE]: 'A patient with this email already exists in your medical center.',
  [ErrorCode.PATIENT_NOT_IN_CENTER]: 'The patient is not in your medical center.',
